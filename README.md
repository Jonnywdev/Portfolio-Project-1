![Mozzs logo](assets/images/mozzs-logo-rm.jpg)
# Mozz's Pizza & BBQ
...
The main aim of this project was to produce a responsive easy to use website, by only using HTML and CSS.

I got inspiration for this project off one of my current jobs at https://www.acebars.co.uk/ my boss always said he would love to re-brand so I thought that I would give it a go.
...
* Secondary Colour - #1F1E20
* Main Typeface Colour - #1F1E20
* Secondary Typeface Colour - #D8CB97
...
- It also has an overlapping div which gives visitors the chance to go straight to our menu page.
* ##### Recent News
...
- All cards have a hover effect which adds shadow to it, giving it the effect it's lifted above the rest.
- All cards are links to separate pages that are unreachable on the main nav bar. 
* ##### Contact us
- The contact us section is seen on all pages other than the "Contact-us" page.
- It is a small section which gives the visitor the chance to jump straight to the contact us section. 

#### Our Menu
* ##### Menu Sections
- Both menu sections are the same, they contain a header and text on the left and 4 images on the right, however when the screen switches to mobile the header and text is centred to the middle and the images are underneath.
* ##### Contact us
- The contact us section is seen on all pages other than the "Contact-us" page.
- It is a small section which gives the visitor the chance to jump straight to the contact us section. 
...
#### About Us
* ##### Company Info
- The company info includes a couple of paragraphs giving the visitor information about who we are, who the owner is and where we have come from.
...
- Like the recent news section the cards are stacked in a row on big/medium screen sizes then switches to columns on smaller screen sizes.
- It also has the same hover effect as the recent news section, with a shadow being added on hover, giving it the effect that it lifts off the page.
* ##### Gallery
- The gallery has lots off different images in it, to show the different range in events that we offer.
- On big screens the column count is 6, on medium screens it is 3 and on smaller screens it is 2.

#### Contact Us
* ##### Contact us section
- This section holds 2 elements a contact form and a text section.
- The contact form has the secondary colour as it's background and takes up 60% of the screen. Our visitors are able to easily contact us by filling out the form and adding a message of what they want from us.
- The text element has useful information on how our customers can contact us if they don't want to use the contact form.
...
- Can learn more about the company.
    > User is able to find any information out easily, they can also access our social media from the links in the footer. Furthermore, they can easily contact us for any other information they need to find out.
...
The horizontal scrolling bar is only viable on the home page, so I new there was an element on that page that wasn't working properly. 
![Screenshot of page having issue with horizontal scroll, using unicorn revealer](assets/images/hor-scroll-u.png)
...
I noticed that as the screen sizes got smaller the margin on the contact page wasn’t working for some reason. I fixed the issue by giving the section with ID contact a position of relative and an element top of 150px.
## Performance Testing
